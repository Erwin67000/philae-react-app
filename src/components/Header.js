...
const Header = () => {
    return (
        <header style={{ backgroundImage: "url('/assets/background.jpg')", backgroundSize: 'cover', padding: '20px', textAlign: 'center' }}>
            <img src="/assets/logo.png" alt="Logo Philae Design" style={{ height: '50px' }} />
            <nav>
